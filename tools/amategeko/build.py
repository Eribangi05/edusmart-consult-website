...
def main():
    ...
    for fn in ("icons.js", "icons.css"):
        shutil.copy(os.path.join(R, fn), os.path.join(OUT, fn))          # the illustrated icon set lives in the Windows app source
    ...
    hh = hashlib.sha1()
    for fn in ("app.js", "web-shim.js", "icons.js", "icons.css", "web.css", "styles.css"):
    ...
    html = html.replace('href="icons.css"', 'href="icons.css?v=' + build_id + '"').replace('src="icons.js"', 'src="icons.js?v=' + build_id + '"')
